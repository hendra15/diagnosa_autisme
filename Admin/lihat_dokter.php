		...
		<div id="content">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<p class="mntp">
					<a href="dokter.php" class="buttonn add">Tambah</a>
					</p>
					<table class="table">
						<tr>
							<th>No</th>
						...
						<?php
							$sql = mysql_query("Select a.nid,a.nama_dokter, a.no_telp_dokter,a.alamat_dokter,d.id_spesialisasi,a.id_kota, b.kota,c.user, c.password from dokter a, id_kota b, login_aja c, spesialisasi d where a.id_kota=b.id_kota and a.user=c.user and a.id_spesialisasi=d.id_spesialisasi order by a.nid asc");
							$no = 1;
							while($r=mysql_fetch_array($sql)){
							$nid = $r['nid'];
							$nama=$r['nama_dokter'];
							$no_telp =$r['no_telp_dokter'];
							$alamat = $r['alamat_dokter'];
							$kota = $r['kota'];
							$id_kota= $r['id_kota'];
							$user=$r['user'];
							$pass=$r['password'];
							$spesialisasi=$r['id_spesialisasi'];
							$sts="perbarui_dokter";
							$bss=base64_encode($nid);
							echo "<tr>
								<td>$no</td>
								<td>$nid</td>
								<td>$nama</td>
								...
								<td>$alamat</td>
								<td>$kota</td>
								<td><a href='detail_dokter.php?bss=$bss'>Detail</a></td>
							<td><a href='dokter.php?nid=$nid&nama_dokter=$nama&no_telp_dokter=$no_telp&spesialisasi=$spesialisasi&alamat_dokter=$alamat&kota=$id_kota&user=$user&password=$pass&sts=$sts'>perbarui</a></td>
								<td><a href=\"Javascript:hapus_dokter('$r[nid]','$user');\">hapus</a></td>
								</tr>";
							$no++;
