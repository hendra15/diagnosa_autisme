		...
		<div id="content">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<p class="mntp">
					<a href="admin.php" class="buttonn add">Tambah</a>
					</p>
					<table class="table">
						<tr>
							<th>No</th>
						...
						<?php
							$sql = mysql_query("Select a.id_admin,a.nama_admin,a.alamat_admin,a.id_kota, b.kota, c.user, c.password from admin a, id_kota b, login_aja c where a.id_kota=b.id_kota and a.user=c.user order by a.id_admin asc");
							$no = 1;
							while($r=mysql_fetch_array($sql)){
							$id = $r['id_admin'];
							$nama=$r['nama_admin'];
							$alamat = $r['alamat_admin'];
							$kota = $r['kota'];
							$id_kota=$r['id_kota'];
							$user=$r['user'];
							$pass=$r['password'];
							...
							echo "<tr>
								...
								<td>$alamat</td>
								<td>$kota</td>
								<td><a href='detail_admin.php?idd=$idd'>Detail</a></td>
								<td><a href='admin.php?id_admin=$id&nama_admin=$nama&alamat_admin=$alamat&id_kota=$id_kota&user=$user&password=$pass&sts=$sts'>perbarui</a></td>
								<td><a href=\"Javascript:hapus_admin('$r[id_admin]','$user');\">hapus</a></td>
								</tr>";
							$no++;
